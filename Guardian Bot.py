...
#token = 'ODk0MjA5MTgzMzQyMjcyNTIz.YVmrMg.9r4ri6oaBMVwtYrbxon7pCzEZ-A'
...
class YTDLSource(discord.PCMVolumeTransformer):
    ...
    def _init_(self, ctx: commands.Context, source: discord.FFmpegPCMAudio, *, data: dict, volume: float = 0.5):
...
class Song:
    _slots_ = ('source', 'requester')

    def _init_(self, source: YTDLSource):
        self.source = source
...
class VoiceState:
    def _init_(self, bot: commands.Bot, ctx: commands.Context):
        self.bot = bot
        self._ctx = ctx
